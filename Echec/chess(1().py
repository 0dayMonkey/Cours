...
def create_board(board):
    board[0] = [Piece('b', 'r', 'black_rook.png'), Piece('b', 'kn', 'black_knight.png'), Piece('b', 'b', 'black_bishop.png'), \
               Piece('b', 'q', 'black_queen.png'), Piece('b', 'k', 'black_king.png'), Piece('b', 'b', 'black_bishop.png'), \
               Piece('b', 'kn', 'black_knight.png'), Piece('b', 'r', 'black_rook.png')]

    board[7] = [Piece('w', 'r', 'white_rook.png'), Piece('w', 'kn', 'white_knight.png'), Piece('w', 'b', 'white_bishop.png'), \
               Piece('w', 'q', 'white_queen.png'), Piece('w', 'k', 'white_king.png'), Piece('w', 'b', 'white_bishop.png'), \
               Piece('w', 'kn', 'white_knight.png'), Piece('w', 'r', 'white_rook.png')]

    for i in range(8):
        board[1][i] = Piece('b', 'p', 'black_pawn.png')
        board[6][i] = Piece('w', 'p', 'white_pawn.png')
    return board
...
class Node:
    ...
    def setup(self, WIN):
        ...
        WIN.blit(pygame.image.load("numbers.png"), (0,0))
        WIN.blit(pygame.image.load("text.png"), (0,780))
